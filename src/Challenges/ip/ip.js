                ...
                <div style={{backgroundImage: 'url(../IP/pattern-bg.png)', height: '250px', position: 'absolute', width: '100%', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
                    <Container>
                        ...
                        <InputGroup className="my-3" style={{marginRight: 'auto', marginLeft: 'auto', maxWidth: '450px'}}>
                                ...
                                <InputGroup.Append>
                                    <Button style={{borderTopRightRadius: '15px', borderBottomRightRadius: '15px', padding: '5px 20px'}} className={classes.Submit} variant="secondary" onClick={() => this.updateDataHandler()}><span className={classes.RightArrow} /></Button>
                                </InputGroup.Append>
                        </InputGroup>
